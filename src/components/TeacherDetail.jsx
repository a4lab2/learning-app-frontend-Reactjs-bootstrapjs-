            ...
            <div className="row">
                ...
                <div className="col-8 text-start">
                    ...
                    <small>
                        ...
                        <p className='fw-bold'>Skills: <Link to="/teacher-detail/1">Golang</Link>, <Link to="/teacher-detail/1">PHP</Link>,
                            <Link to="/teacher-detail/1">Python</Link></p>
                        <p className='fw-bold'>Recent Courses: <Link to="/teacher-detail/1">Golang</Link></p>
